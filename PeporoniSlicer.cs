...
namespace Mod
{
    ...
    public class PeporoniSlicer : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun pepGun = ETGMod.Databases.Items.NewGun("Peporoni Slicer", "pep");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:peporoni_slicer", "kp:pepporoni_slicer");
            pepGun.gameObject.AddComponent<PeporoniSlicer>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            pepGun.SetShortDescription("Mamma Mai");
            pepGun.SetLongDescription("A gun left out on a slice of pizza, the pizza has rotted away but the meat looks like it's fresh.");
            ...
            pepGun.SetupSprite(null, "pep_idle_001", 1);
            ...
            pepGun.encounterTrackable.EncounterGuid = "Pepo";
            ...
            projectile.SetProjectileSpriteRight("pep_fire_001", 8, 8, true, tk2dBaseSprite.Anchor.MiddleCenter, 6, 6);
